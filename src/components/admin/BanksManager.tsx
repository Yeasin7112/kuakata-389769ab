...
interface Bank { id: string; name_bn: string; name_en: string; branch_bn: string | null; branch_en: string | null; address_bn: string | null; address_en: string | null; phone: string | null; has_atm: boolean | null; is_active: boolean | null; }
...
const BanksManager: React.FC = () => {
  ...
  const [formData, setFormData] = useState({ name_bn: '', name_en: '', branch_bn: '', branch_en: '', address_bn: '', address_en: '', phone: '', has_atm: true, is_active: true });
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => { setEditing(null); setFormData({ name_bn: '', name_en: '', branch_bn: '', branch_en: '', address_bn: '', address_en: '', phone: '', has_atm: true, is_active: true }); setIsDialogOpen(true); }}><Plus className="w-4 h-4 mr-2" />Add</Button>
      </div>
